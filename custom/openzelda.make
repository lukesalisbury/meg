...
PLATFORM_FLAGS += -DPACKAGE_URL="\"http://openzelda.nfshost.com/userpackages/1.9.0\""

#PLATFORM_FLAGS += -DQ2A_URL="\"http://openzelda.nfshost.com/qa/xml-rpc\""

PLATFORM_FLAGS += -DCUSTOMSETTINGS
PLATFORM_FLAGS += -I$(CUSTOMPATH)


PLATFORM_FLAGS += -DBUG_URL="\"http://openzelda.nfshost.com/\#!Bugs\""
PLATFORM_FLAGS += -DFORUM_URL="\"http://openzelda.nfshost.com/\#!Message\""
PLATFORM_FLAGS += -DMANUAL_URL="\"http://openzelda.github.io/openzelda-docs/\""
PLATFORM_FLAGS += -DFORCE_PACKAGE="\"OpenZelda-2_0-beta1.core.package\""
PLATFORM_FLAGS += -DFORCE_PACKAGE_URL="\"http://openzelda.nfshost.com/get/OpenZelda-2_0-beta1.core.package\""
PLATFORM_FLAGS += -DFORCE_PACKAGE_CHECKSUM_URL="\"http://openzelda.nfshost.com/package/2_0-beta1.txt\""
PLATFORM_FLAGS += -DPROGRAM_UPDATE_URL="\"http://openzelda.nfshost.com/version/1_9_0.txt\""
