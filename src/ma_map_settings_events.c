...
void Meg_MapSettings_Centerview_Set( GtkToggleButton * togglebutton, GtkWidget * map_widget )
{
	...
	RuntimeSetting_UpdateBoolean( map_info->settings, "centerview", gtk_toggle_button_get_active( togglebutton ), "hidden" );
}
...
void Meg_MapSettings_Independent_Set( GtkToggleButton * togglebutton, GtkWidget * map_widget )
{
	...
	RuntimeSetting_UpdateBoolean( map_info->settings, "independent", gtk_toggle_button_get_active( togglebutton ), "hidden" );
}
...
void Meg_MapSettings_Wrap_Set( GtkComboBox * widget, GtkWidget * map_widget )
{
	...
	RuntimeSetting_UpdateValue( map_info->settings, "wrap", gtk_combo_box_get_active( GTK_COMBO_BOX(widget) ), "hidden" );
}
...
void Meg_MapSettings_Centerview_Get( GtkToggleButton * togglebutton, GtkWidget * map_widget )
{
	...
	MapInfo * map_info = gtk_alchera_map_get_info( GTK_ALCHERA_MAP(map_widget) );
	gtk_toggle_button_set_active( GTK_TOGGLE_BUTTON(togglebutton), RuntimeSetting_BooleanCheck( map_info->settings, "centerview" ) );
}
...
void Meg_MapSettings_Independent_Get( GtkToggleButton * widget, GtkWidget * map_widget )
{
	...
	MapInfo * map_info = gtk_alchera_map_get_info( GTK_ALCHERA_MAP(map_widget) );
	gtk_toggle_button_set_active( GTK_TOGGLE_BUTTON(widget), RuntimeSetting_BooleanCheck( map_info->settings, "independent" )  );
}
...
void Meg_MapSettings_Wrap_Get(GtkComboBox * widget, GtkWidget *map_widget )
{
	...
	MapInfo * map_info = gtk_alchera_map_get_info( GTK_ALCHERA_MAP(map_widget) );
	gtk_combo_box_set_active( GTK_COMBO_BOX(widget), RuntimeSetting_GetValue( map_info->settings, "wrap" ) );
}
