...
extern const PHYSFS_ArchiveInfo    __PHYSFS_ArchiveInfo_MokoiResource;
extern const PHYSFS_Archiver       __PHYSFS_Archiver_MokoiResource;
...
#endif
	#if (defined PHYSFS_SUPPORTS_MOKOIRESOURCE)
		&__PHYSFS_Archiver_MokoiResource,
	#endif
	NULL
};
